class ApplicationController < ActionController::Base
  ...
  MEMBER_SEARCH_FIELDS          = "id,name,profile_pic__c,summary_bio__c,challenges_entered__c,total_wins__c,total_1st_place__c,total_2nd_place__c,total_3st_place__c"
