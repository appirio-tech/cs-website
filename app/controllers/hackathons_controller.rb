class HackathonsController < ApplicationController
  ...
  def show
    ...
    @links = dbdc_client.query("select Id, Name, URL__c, Description__c from Hackathon_Link__c
    ...
    @pages = dbdc_client.query("select Id, Name from Hackathon_Webpage__c where hackathon__c = '#{@hack['Id']}'")
